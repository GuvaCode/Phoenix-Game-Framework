...
uses
  ...
  Dialogs, ComCtrls, StdCtrls, ImgList, ExtCtrls, ToolWin, Menus, Mask, JvExMask, JvSpin,
...
begin
  ...
  begin
    Filter:=Filter + ';*'+ String(GraphicFormats.Items[Index].Extension);
  end;
...
begin
  ...
  repeat
    ...
    for Index := 0 to Items.Count - 1 do
    begin
      Done:= Done and Partition.Insert(Items[Index].Width, Items[Index].Height, ARect);
