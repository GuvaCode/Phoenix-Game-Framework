...
type
  TFrmCharacter = class(TFrame)
    ...
    edFlagNotEnd: TCheckBox;
    procedure pbPreviewPaint(Sender: TObject);
    procedure edCharacterChange(Sender: TObject);
    procedure btnSetOffsetYClick(Sender: TObject);
    procedure edYOffsetChange(Sender: TObject);
    procedure edFlagWrapClick(Sender: TObject);
    procedure edFlagNotStartClick(Sender: TObject);
    procedure edFlagNotEndClick(Sender: TObject);
  private
    FFont      : TPHXFont;
    FBuffer    : TBitmap;
    FBackground: TBitmap;
...
//------------------------------------------------------------------------------
procedure TFrmCharacter.edFlagWrapClick(Sender: TObject);
var Value: TPHXCharacterFlags;
begin
  Value:= FCharacter.Flags;

  if edFlagNotEnd.Checked then
  begin
   Include(Value, cfWrap);
  end else
  begin
   Exclude(Value, cfWrap);
  end;

  if FCharacter.Flags <> Value then
  begin
    FCharacter.Flags:= Value;
...
//------------------------------------------------------------------------------
procedure TFrmCharacter.edFlagNotStartClick(Sender: TObject);
var Value: TPHXCharacterFlags;
begin
  Value:= FCharacter.Flags;
  ...
  if edFlagNotEnd.Checked then
  begin
   Include(Value, cfNotStart);
  end else
  begin
   Exclude(Value, cfNotStart);
  end;
...
//------------------------------------------------------------------------------
procedure TFrmCharacter.edFlagNotEndClick(Sender: TObject);
var Value: TPHXCharacterFlags;
begin
  Value:= FCharacter.Flags;
  ...
  if edFlagNotEnd.Checked then
  begin
   Include(Value, cfNotEnd);
  end else
  begin
   Exclude(Value, cfNotEnd);
  end;
...
begin
  ...
  edFlagWrap    .Checked:= (cfWrap     in Character.Flags);
  edFlagNotStart.Checked:= (cfNotStart in Character.Flags);
  edFlagNotEnd  .Checked:= (cfNotEnd   in Character.Flags);
