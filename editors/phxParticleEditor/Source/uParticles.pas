...
procedure TFrmParticles.lwParticlesUpdate;
var Count   : Integer;
var Index   : Integer;
var Item    : TListItem;
...
begin
 ...
 // end;
  ...
  begin
    ...
    Item.SubItems[0]:= Format('%.1f', [Particle.Energy        ], FS) ;
    Item.SubItems[1]:= Format('%.1f', [Particle.Time           ], FS) ;
    Item.SubItems[2]:= Format('%.1f', [Particle.Life           ], FS) ;
    Item.SubItems[3]:= Format('%.1f', [Particle.Color.Alpha           ], FS) ;
    Item.SubItems[4]:=  '';
    Item.SubItems[4]:=  '';
  end;
...
procedure TFrmParticles.SetSystem(const Value: TPHXParticleSystem);
begin
...
//------------------------------------------------------------------------------
procedure TFrmParticles.Timer1Timer(Sender: TObject);
begin
